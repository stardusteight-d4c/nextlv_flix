...
const HomeCard = ({
  ...
  return (
    <>
      <div className="box">
        <div className="absolute top-0 w-full h-[100vh] -z-10 after:absolute after:top-0 after:left-0 after:w-full after:h-[100vh] after:z-40 after:bg-gradient-to-br after:from-black/70 after:to-black/20">
        ...
        <div className="py-20 px-32 flex">
          <div className="max-w-[50vw]">
            ...
            <button className="bg-gray-900/50 border-2 border-red-300">
              <i className="fas fa-play py-4"></i> ASSISTIR
            </button>
          </div>
